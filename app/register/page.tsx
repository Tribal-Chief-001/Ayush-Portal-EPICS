...
export default function RegisterPage() {
    ...
    const inputClass = (field: string) =>
        `w-full px-4 py-2.5 border rounded-lg text-sm focus:outline-none focus:ring-2 transition-all ${errors[field] ? "border-red-400 focus:ring-red-200" : "border-slate-200 dark:border-white/10 focus:ring-primary/40"}`;
        ...
        return (
            <div className="min-h-screen bg-background-light font-display flex items-center justify-center">
                <div className="max-w-md text-center p-10">
                    ...
                    <h1 className="text-3xl font-bold text-slate-900 dark:text-slate-100 mb-3">Registration Submitted!</h1>
        ...
        <div className="min-h-screen bg-background-light font-display">
            ...
            <main className="max-w-4xl mx-auto px-4 py-12">
                ...
                <div className="text-center mb-10">
                    <h1 className="text-3xl font-bold text-slate-900 dark:text-slate-100 mb-2">Registration Wizard</h1>
                    <p className="text-slate-500 dark:text-slate-400">Complete the steps below to register your AYUSH startup.</p>
                </div>
                        ...
                        <div key={step} className="flex items-center">
                            <div className="flex flex-col items-center">
                                <div className={`w-10 h-10 rounded-full flex items-center justify-center text-sm font-bold border-2 transition-all ${index < currentStep
                                    ...
                                    : index === currentStep
                                        ? "border-primary text-primary-dark bg-white dark:bg-[#111111]"
                                        : "border-slate-300 text-slate-500 dark:text-slate-400 bg-white dark:bg-[#111111]"
                                    }`}>
                                    {index < currentStep ? (
                                ...
                                <span className={`text-xs mt-2 font-semibold hidden sm:block ${index <= currentStep ? "text-primary-dark" : "text-slate-500 dark:text-slate-400"}`}>{step}</span>
                            </div>
                            {index < steps.length - 1 && (
                                <div className={`w-16 sm:w-32 h-0.5 mx-2 mb-5 sm:mb-0 ${index < currentStep ? "bg-primary" : "bg-slate-100 dark:bg-slate-800"}`}></div>
                            )}
                        </div>
                    ))}
                </div>
                ...
                {/* Step Content */}
                <div className="bg-white dark:bg-[#111111] rounded-2xl shadow-[0_4px_20px_rgba(0,0,0,0.5)] border border-slate-200 dark:border-white/5 p-6 sm:p-8 mb-8">
                    ...
                    {currentStep === 0 && (
                        <div>
                            <div className="flex items-center gap-2 mb-1">
                                ...
                                <h2 className="text-xl font-bold text-slate-900 dark:text-slate-100">Founder Information</h2>
                            </div>
                            <p className="text-slate-500 dark:text-slate-400 text-sm mb-8">Tell us about yourself to get started.</p>
                            ...
                            <div className="grid sm:grid-cols-2 gap-5">
                                ...
                                <div>
                                    ...
                                    <div className="flex">
                                        <span className="inline-flex items-center px-3 bg-slate-50 dark:bg-[#0a0a0a] border border-r-0 border-slate-200 dark:border-white/10 rounded-l-lg text-sm text-slate-500 dark:text-slate-400">+91</span>
                    ...
                    {currentStep === 1 && (
                        <div>
                            ...
                            <p className="text-slate-500 dark:text-slate-400 text-sm mb-8">Provide information about your AYUSH startup.</p>
                            ...
                            <div className="grid sm:grid-cols-2 gap-5">
                                ...
                                <div>
                                    <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1.5">AYUSH Sector *</label>
                                ...
                                <div>
                                    <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1.5">DIPP / Recognition Number</label>
                                ...
                                <div>
                                    <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1.5">Date of Incorporation *</label>
                                ...
                                <div className="sm:col-span-2">
                                    <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1.5">Startup Description *</label>
                    ...
                    {currentStep === 2 && (
                        <div>
                            <div className="flex items-center gap-2 mb-1">
                                ...
                                <h2 className="text-xl font-bold text-slate-900 dark:text-slate-100">Upload Required Documents</h2>
                            </div>
                            <p className="text-slate-500 dark:text-slate-400 text-sm mb-8">Please provide the following documents to verify your startup&apos;s eligibility under AYUSH guidelines. All files are securely encrypted.</p>

                            {/* GST Certificate */}
                            <div className="border-b border-slate-200 dark:border-white/5 pb-6 mb-6">
                                <div className="flex items-center gap-2 mb-1">
                                    <h3 className="font-bold text-slate-900 dark:text-slate-100">GST Certificate *</h3>
                                    <span className="material-icons text-slate-500 dark:text-slate-400 text-base cursor-help" title="Required for tax verification">help_outline</span>
                                </div>
                                <p className="text-xs text-slate-500 dark:text-slate-400 mb-4">Required for tax verification purposes.</p>
                                {form.gstFile ? (
                                    <div className="bg-primary/5 border border-primary/20 rounded-lg p-3 flex items-center gap-3">
                                        <span className="material-icons text-red-500">picture_as_pdf</span>
                                        <div className="flex-1">
                                            <p className="text-sm font-medium text-slate-900 dark:text-slate-100">{form.gstFile.name}</p>
                                            <p className="text-xs text-green-600 flex items-center gap-1">
                                                <span className="material-icons text-xs">check_circle</span> Uploaded ({(form.gstFile.size / 1024).toFixed(1)} KB)
                                            </p>
                                        </div>
                                        <button onClick={() => setFile("gstFile", null)} className="text-slate-500 dark:text-slate-400 hover:text-red-500">
                                    ...
                                    <div
                                        ...
                                        className={`border-2 border-dashed rounded-lg p-8 text-center cursor-pointer transition-colors ${dragOver === "gst" ? "border-primary bg-primary/5" : "border-slate-200 dark:border-white/10 hover:border-primary/50"}`}
                                    >
                                        ...
                                        <span className="material-icons text-slate-500 dark:text-slate-400 text-3xl mb-2">upload_file</span>
                                        <p className="text-sm"><span className="text-primary-dark font-medium">Click to upload</span> or drag and drop</p>
                                        <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">PDF, PNG, JPG (max. 5MB)</p>
                                    </div>
                                )}
                            ...
                            <div className="border-b border-slate-200 dark:border-white/5 pb-6 mb-6">
                                <div className="flex items-center gap-2 mb-1">
                                    <h3 className="font-bold text-slate-900 dark:text-slate-100">Clinical Trial Data</h3>
                                    <span className="px-2 py-0.5 bg-slate-100 dark:bg-[#141414] text-slate-500 dark:text-slate-400 text-[10px] rounded-full font-medium">OPTIONAL</span>
                                </div>
                                <p className="text-xs text-slate-500 dark:text-slate-400 mb-4">If applicable for your product category.</p>
                                {form.clinicalFile ? (
                                    <div className="bg-primary/5 border border-primary/20 rounded-lg p-3 flex items-center gap-3">
                                        <span className="material-icons text-blue-500">description</span>
                                        <div className="flex-1">
                                            <p className="text-sm font-medium text-slate-900 dark:text-slate-100">{form.clinicalFile.name}</p>
                                            <p className="text-xs text-green-600 flex items-center gap-1">
                                                <span className="material-icons text-xs">check_circle</span> Uploaded ({(form.clinicalFile.size / 1024).toFixed(1)} KB)
                                            </p>
                                        </div>
                                        <button onClick={() => setFile("clinicalFile", null)} className="text-slate-500 dark:text-slate-400 hover:text-red-500">
                                            <span className="material-icons text-lg">delete</span>
                                        </button>
                                    </div>
                                ) : (
                                    <div
                                        ...
                                        className={`border-2 border-dashed rounded-lg p-8 text-center cursor-pointer transition-colors ${dragOver === "clinical" ? "border-primary bg-primary/5" : "border-slate-200 dark:border-white/10 hover:border-primary/50"}`}
                                    >
                                        ...
                                        <span className="material-icons text-slate-500 dark:text-slate-400 text-3xl mb-2">upload</span>
                                        <p className="text-sm"><span className="text-primary-dark font-medium">Click to upload</span> or drag and drop</p>
                                        <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">PDF, DOCX, XLSX (max. 10MB)</p>
                                    </div>
                                )}
                            </div>
                            ...
                            <div>
                                <div className="flex items-center gap-2 mb-1">
                                    <h3 className="font-bold text-slate-900 dark:text-slate-100">AYUSH Certification</h3>
                                    <span className="px-2 py-0.5 bg-slate-100 dark:bg-[#141414] text-slate-500 dark:text-slate-400 text-[10px] rounded-full font-medium">OPTIONAL</span>
                                </div>
                                <p className="text-xs text-slate-500 dark:text-slate-400 mb-4">Proof of adherence to AYUSH guidelines.</p>
                                {form.certFile ? (
                                    <div className="bg-primary/5 border border-primary/20 rounded-lg p-3 flex items-center gap-3">
                                        <span className="material-icons text-green-500">verified</span>
                                        <div className="flex-1">
                                            <p className="text-sm font-medium text-slate-900 dark:text-slate-100">{form.certFile.name}</p>
                                            <p className="text-xs text-green-600 flex items-center gap-1">
                                                <span className="material-icons text-xs">check_circle</span> Uploaded ({(form.certFile.size / 1024).toFixed(1)} KB)
                                            </p>
                                        </div>
                                        <button onClick={() => setFile("certFile", null)} className="text-slate-500 dark:text-slate-400 hover:text-red-500">
                                            <span className="material-icons text-lg">delete</span>
                                        </button>
                                    </div>
                                ) : (
                                    <div
                                        ...
                                        className={`border-2 border-dashed rounded-lg p-8 text-center cursor-pointer transition-colors ${dragOver === "cert" ? "border-green-400 bg-green-50" : "border-slate-200 dark:border-white/10 hover:border-primary/50"}`}
                                    >
                                        ...
                                        <span className="material-icons text-slate-500 dark:text-slate-400 text-3xl mb-2">cloud_upload</span>
                                        <p className="text-sm"><span className="text-primary-dark font-medium">Click to upload</span> or drag and drop</p>
                                        <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">PDF, PNG, JPG (max. 5MB)</p>
                                    </div>
                                )}
                    ...
                    {currentStep === 3 && (
                        <form onSubmit={handleSubmit}>
                            ...
                            <p className="text-slate-500 dark:text-slate-400 text-sm mb-8">Please verify all information before submitting your application.</p>

                            {/* Founder Info Review */}
                            <div className="mb-6">
                                <div className="flex items-center justify-between mb-3">
                                    <h3 className="font-bold text-sm text-slate-900 dark:text-slate-100 uppercase tracking-wider">Founder Information</h3>
                                    <button type="button" onClick={() => setCurrentStep(0)} className="text-xs text-primary-dark font-medium hover:underline">Edit</button>
                                </div>
                                <div className="bg-slate-50 dark:bg-[#0a0a0a] rounded-lg p-4 grid sm:grid-cols-2 gap-3 text-sm">
                                    <div><span className="text-slate-500 dark:text-slate-400">Name:</span> <span className="font-medium text-slate-900 dark:text-slate-100 ml-1">{form.founderName}</span></div>
                                    <div><span className="text-slate-500 dark:text-slate-400">Email:</span> <span className="font-medium text-slate-900 dark:text-slate-100 ml-1">{form.email}</span></div>
                                    <div><span className="text-slate-500 dark:text-slate-400">Phone:</span> <span className="font-medium text-slate-900 dark:text-slate-100 ml-1">+91 {form.phone}</span></div>
                                </div>
                            </div>
                            ...
                            <div className="mb-6">
                                <div className="flex items-center justify-between mb-3">
                                    <h3 className="font-bold text-sm text-slate-900 dark:text-slate-100 uppercase tracking-wider">Business Details</h3>
                                    <button type="button" onClick={() => setCurrentStep(1)} className="text-xs text-primary-dark font-medium hover:underline">Edit</button>
                                </div>
                                <div className="bg-slate-50 dark:bg-[#0a0a0a] rounded-lg p-4 grid sm:grid-cols-2 gap-3 text-sm">
                                    <div><span className="text-slate-500 dark:text-slate-400">Startup:</span> <span className="font-medium text-slate-900 dark:text-slate-100 ml-1">{form.startupName}</span></div>
                                    <div><span className="text-slate-500 dark:text-slate-400">Sector:</span> <span className="font-medium text-slate-900 dark:text-slate-100 ml-1">{form.ayushSector}</span></div>
                                    <div><span className="text-slate-500 dark:text-slate-400">DIPP:</span> <span className="font-medium text-slate-900 dark:text-slate-100 ml-1">{form.dippNumber || "—"}</span></div>
                                    <div><span className="text-slate-500 dark:text-slate-400">Incorporated:</span> <span className="font-medium text-slate-900 dark:text-slate-100 ml-1">{form.incorporationDate}</span></div>
                                    <div><span className="text-slate-500 dark:text-slate-400">Location:</span> <span className="font-medium text-slate-900 dark:text-slate-100 ml-1">{form.city ? `${form.city}, ` : ""}{form.state}</span></div>
                                    <div><span className="text-slate-500 dark:text-slate-400">Team:</span> <span className="font-medium text-slate-900 dark:text-slate-100 ml-1">{form.teamSize || "—"}</span></div>
                                    <div className="sm:col-span-2"><span className="text-slate-500 dark:text-slate-400">Description:</span> <span className="font-medium text-slate-900 dark:text-slate-100 ml-1">{form.description}</span></div>
                                </div>
                            </div>
                            ...
                            <div className="mb-8">
                                <div className="flex items-center justify-between mb-3">
                                    <h3 className="font-bold text-sm text-slate-900 dark:text-slate-100 uppercase tracking-wider">Documents</h3>
                                    <button type="button" onClick={() => setCurrentStep(2)} className="text-xs text-primary-dark font-medium hover:underline">Edit</button>
                                </div>
                                <div className="bg-slate-50 dark:bg-[#0a0a0a] rounded-lg p-4 space-y-2 text-sm">
                                    <div className="flex items-center gap-2">
                                        <span className="material-icons text-green-500 text-base">check_circle</span>
                                        <span className="text-slate-700 dark:text-slate-300">GST Certificate: <strong>{form.gstFile?.name}</strong></span>
                                    </div>
                                    <div className="flex items-center gap-2">
                                        {form.clinicalFile ? (
                                            <>
                                                <span className="material-icons text-green-500 text-base">check_circle</span>
                                                <span className="text-slate-700 dark:text-slate-300">Clinical Trial Data: <strong>{form.clinicalFile.name}</strong></span>
                                            </>
                                        ) : (
                                            <>
                                                <span className="material-icons text-slate-700 dark:text-slate-300 text-base">remove_circle_outline</span>
                                                <span className="text-slate-500 dark:text-slate-400">Clinical Trial Data: Not uploaded</span>
                                            </>
                                        )}
                                    </div>
                                    <div className="flex items-center gap-2">
                                        {form.certFile ? (
                                            <>
                                                <span className="material-icons text-green-500 text-base">check_circle</span>
                                                <span className="text-slate-700 dark:text-slate-300">AYUSH Certification: <strong>{form.certFile.name}</strong></span>
                                            </>
                                        ) : (
                                            <>
                                                <span className="material-icons text-slate-700 dark:text-slate-300 text-base">remove_circle_outline</span>
                                                <span className="text-slate-500 dark:text-slate-400">AYUSH Certification: Not uploaded</span>
                                            </>
                                        )}
                                    </div>
                                </div>
                    ...
                    {currentStep < 3 && (
                        <div className="flex justify-between items-center pt-6 mt-6 border-t border-slate-200 dark:border-white/5">
                            <button
                                ...
                                className={`inline-flex items-center px-6 py-2.5 border border-slate-200 dark:border-white/10 rounded-lg text-sm font-medium transition-colors ${currentStep === 0 ? "text-slate-700 dark:text-slate-300 cursor-not-allowed" : "text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:bg-[#0a0a0a]"}`}
                            >
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                    <div className="bg-white dark:bg-[#111111] rounded-xl border border-slate-200 dark:border-white/5 p-5 flex items-start gap-3">
                        <div className="w-8 h-8 rounded-full bg-blue-100 flex items-center justify-center flex-shrink-0">
                            <span className="material-icons text-blue-600 text-sm">info</span>
                        </div>
                        <div>
                            <h4 className="font-bold text-sm text-slate-900 dark:text-slate-100">Need Help?</h4>
                            <p className="text-xs text-slate-500 dark:text-slate-400">Refer to the <a href="#" className="text-primary-dark font-medium hover:underline">Official AYUSH Guidelines</a> for document templates.</p>
                        </div>
                    </div>
                    <div className="bg-white dark:bg-[#111111] rounded-xl border border-slate-200 dark:border-white/5 p-5 flex items-start gap-3">
                        ...
                        <div>
                            <h4 className="font-bold text-sm text-slate-900 dark:text-slate-100">Data Privacy</h4>
                            <p className="text-xs text-slate-500 dark:text-slate-400">Your documents are encrypted and only accessible by the verification committee.</p>
                        </div>
                    </div>
                </div>
