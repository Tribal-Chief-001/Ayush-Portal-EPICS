    ...
    try {
        ...
        const formatted = applications.map((app) => {
            ...
            return {
                ...
                color: avatarColors[profile?.ayushSector || ""] || "bg-slate-100 text-slate-700",
                sector: profile?.ayushSector || "N/A",
                sectorColor: sectorColors[profile?.ayushSector || ""] || "bg-slate-50 text-slate-700",
                ...
                statusColor: statusColors[app.status] || "bg-slate-100 text-slate-700",
                details: {
