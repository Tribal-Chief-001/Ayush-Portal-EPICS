    ...
    try {
        ...
        const formatted = applications.map((app) => {
            ...
            return {
                ...
                color: avatarColors[profile?.ayushSector || ""] || "bg-[#141414] text-slate-300",
                sector: profile?.ayushSector || "N/A",
                sectorColor: sectorColors[profile?.ayushSector || ""] || "bg-[#0a0a0a] text-slate-300",
                ...
                statusColor: statusColors[app.status] || "bg-[#141414] text-slate-300",
                details: {
