    ...
    return (
        <>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
                        ...
                        >
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                ...
                                <button className="inline-flex items-center justify-center px-8 py-3.5 text-base font-semibold text-slate-300 bg-[#111111] border border-white/10 rounded-xl hover:bg-[#1a1a1a] shadow-[0_15px_40px_rgba(0,0,0,0.8)] shadow-black transition-all">
                        ...
                        >
                            ...
                            {/* Main Card */}
                            <div className="relative w-full max-w-md bg-[#111111] rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.9)] shadow-black border border-white/10 overflow-hidden transform hover:-translate-y-2 transition-transform duration-500">
                                <div
                                ...
                                >
                                    <div className="absolute top-4 right-4 bg-[#0a0a0a]/90 backdrop-blur px-3 py-1 rounded-full text-xs font-bold text-emerald-400 border border-white/10 shadow-[0_4px_20px_rgba(0,0,0,0.5)]">
                                        5,000+ Startups
                                    </div>
                                </div>
                                <div className="p-6">
                                    <div className="flex items-center gap-3 mb-4">
                                        ...
                                        <div>
                                            <h3 className="font-bold text-slate-100">AyurTech Innovations</h3>
                                    ...
                                    <div className="mt-6 flex justify-between items-center">
                                        <div className="text-xs text-slate-400">Status: <span className="text-emerald-500 font-medium">Active</span></div>
                                        <button className="text-xs bg-[#0a0a0a] border border-white/10 text-white px-3 py-1.5 rounded-md font-semibold hover:bg-[#1a1a1a] transition-colors">View Details</button>
                                    </div>
                                </div>
                            </div>
                            {/* Floating Elements */}
                            <motion.div 
                                ...
                                className="absolute -bottom-6 -left-6 bg-[#111111] p-4 rounded-xl shadow-[0_20px_50px_rgba(0,0,0,0.9)] border border-white/10 flex items-center gap-3"
                            >
                                <span className="material-icons text-emerald-500 bg-emerald-500/10 border border-emerald-500/20 p-2 rounded-lg">spa</span>
                                <div>
                                    <p className="text-xs text-slate-400">Disbursed Today</p>
                                    <p className="text-sm font-bold text-slate-100">₹ 2.4 Crores</p>
                                </div>
                            </motion.div>
                            <motion.div 
                                animate={{ y: [10, -10, 10] }}
                                transition={{ repeat: Infinity, duration: 5, ease: "easeInOut" }}
                                className="absolute top-10 -right-4 bg-[#111111] p-4 rounded-xl shadow-[0_20px_50px_rgba(0,0,0,0.9)] border border-white/10 flex items-center gap-3"
                            >
                                ...
                                <div>
                                    ...
                                    <p className="text-sm font-bold text-slate-100">ISO Certified</p>
                                </div>
                            </motion.div>
                        </motion.div>
                    </div>
            ...
            <motion.div 
                ...
                className="bg-[#0a0a0a] border-y border-white/5 relative z-20"
            >
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center divide-x divide-white/5">
                        <div>
                            <div className="text-4xl font-black text-slate-100 drop-shadow-lg">12,450+</div>
                            <div className="text-xs font-semibold text-emerald-500 mt-2 uppercase tracking-widest">Registered Startups</div>
                        </div>
                        <div>
                            <div className="text-4xl font-black text-slate-100 drop-shadow-lg">₹450 Cr</div>
                            <div className="text-xs font-semibold text-emerald-500 mt-2 uppercase tracking-widest">Funding Disbursed</div>
                        </div>
                        <div>
                            <div className="text-4xl font-black text-slate-100 drop-shadow-lg">850+</div>
                            <div className="text-xs font-semibold text-emerald-500 mt-2 uppercase tracking-widest">Active Investors</div>
                        </div>
                        <div>
                            <div className="text-4xl font-black text-slate-100 drop-shadow-lg">150+</div>
            ...
            <section className="py-24 bg-[#111111] relative z-10">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        <h2 className="text-3xl md:text-5xl font-black text-slate-100 mb-6 tracking-tight">A Unified Ecosystem</h2>
                        <p className="text-slate-400 text-lg">Bringing together all stakeholders of the AYUSH ecosystem under one globally-connected digital roof to foster innovation and geometric growth.</p>
                    </motion.div>
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        ...
                        <motion.div 
                            ...
                            className="group relative bg-[#0a0a0a] rounded-2xl p-8 hover:shadow-[0_20px_50px_rgba(0,0,0,0.9)] shadow-black transition-all border border-white/5 hover:border-emerald-500/30 overflow-hidden"
                        >
                            ...
                            <h3 className="text-2xl font-bold text-slate-100 mb-4">For Startups</h3>
                            <p className="text-slate-400 mb-8 text-base leading-relaxed h-20">
                        ...
                        >
                            ...
                            <div className="w-14 h-14 bg-[#1a1a1a] border border-white/10 rounded-xl flex items-center justify-center mb-8 shadow-[0_15px_40px_rgba(0,0,0,0.8)] shadow-black group-hover:scale-110 transition-transform duration-300">
                                <span className="material-icons text-white text-2xl">paid</span>
                            </div>
                            <h3 className="text-2xl font-bold text-slate-100 mb-4">For Investors</h3>
                            <p className="text-slate-400 mb-8 text-base leading-relaxed h-20">
                            ...
                            <Link href="/investors" className="inline-flex items-center text-slate-100 font-semibold text-sm group-hover:translate-x-2 transition-transform duration-300">
                        ...
                        >
                            ...
                            <div className="w-14 h-14 bg-[#111111] border border-emerald-500/20 rounded-xl flex items-center justify-center mb-8 shadow-[0_15px_40px_rgba(0,0,0,0.8)] shadow-black group-hover:scale-110 transition-transform duration-300">
                                <span className="material-icons text-emerald-500 text-2xl">gavel</span>
                            </div>
                            <h3 className="text-2xl font-bold text-slate-100 mb-4">Government</h3>
                            <p className="text-slate-400 mb-8 text-base leading-relaxed h-20">
                                Monitor ecosystem growth kinetics, dynamically verify startups, and manage national policy implementation directly.
                            </p>
                            <Link href="/admin" className="inline-flex items-center text-slate-100 font-semibold text-sm group-hover:translate-x-2 transition-transform duration-300">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="flex flex-col md:flex-row gap-16 items-center">
                        ...
                        >
                            ...
                            <img
                                className="rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.9)] shadow-black border border-white/10 object-cover h-[500px] w-full"
                        ...
                        >
                            ...
                            <h2 className="text-4xl md:text-5xl font-black text-slate-100 mb-6 leading-tight">Zero Red Tape.<br />Maximum <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-primary">Velocity.</span></h2>
                            ...
                            <div className="space-y-8">
                                <div className="flex gap-5">
                                    <div className="flex-shrink-0">
                                        <div className="w-14 h-14 rounded-full bg-[#111111] border border-emerald-500/20 flex items-center justify-center shadow-[0_10px_30px_rgba(0,0,0,0.5)] shadow-black">
                                            <span className="material-icons text-emerald-500">visibility</span>
                                        </div>
                                    </div>
                                    <div>
                                        <h4 className="text-xl font-bold text-slate-100">Absolute Transparency</h4>
                                        <p className="text-slate-400 text-sm mt-2 leading-relaxed">Observe your application trajectory in real-time through the terminal metrics. No black boxes.</p>
                                    </div>
                                </div>
                                <div className="flex gap-5">
                                    <div className="flex-shrink-0">
                                    ...
                                    <div>
                                        <h4 className="text-xl font-bold text-slate-100">Automated Clearances</h4>
                                        <p className="text-slate-400 text-sm mt-2 leading-relaxed">A specialized OSINT agent validates your compliance footprint within sector algorithms rapidly.</p>
                                    </div>
                                </div>
                                <div className="flex gap-5">
                                    <div className="flex-shrink-0">
                                    ...
                                    <div>
                                        <h4 className="text-xl font-bold text-slate-100">Enterprise Encryption</h4>
                                        <p className="text-slate-400 text-sm mt-2 leading-relaxed">AES-256 database protection securing intellectual property and founder telemetry end-to-end.</p>
                                    </div>
                                </div>
                            </div>
                        </motion.div>
            ...
            {/* Call to Action */}
            <section className="py-24 relative z-20 bg-[#111111] border-t border-white/5">
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    <motion.div 
                        ...
                        viewport={{ once: true }}
                        transition={{ duration: 0.8, ease: "easeOut" }}
                        className="bg-gradient-to-br from-[#1a1a1a] to-[#0a0a0a] rounded-[2rem] p-12 md:p-20 text-center relative overflow-hidden shadow-[0_30px_60px_rgba(0,0,0,0.95)] shadow-black border border-white/10"
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="text-slate-300 mb-12 max-w-2xl mx-auto text-xl font-medium leading-relaxed">Connect to the national matrix of founders modernizing Ayurveda, Yoga, Unani, Siddha, and Homeopathy.</p>
                            <div className="flex flex-col sm:flex-row justify-center gap-6">
                                ...
                                <Link href="/schemes" className="inline-flex items-center justify-center px-10 py-5 text-lg font-bold text-slate-200 border-2 border-slate-700/50 rounded-2xl hover:bg-white/5 hover:border-slate-600 hover:text-white transition-all duration-300 backdrop-blur-sm">
                                    View Policy Matrix
                                </Link>
                            </div>
                        </div>
