...
const resources = [
    {
        ...
        details: [
            ...
            { icon: "account_balance_wallet", text: "Grant: Up to ₹50 Lakhs", color: "text-slate-500 dark:text-slate-400" },
            { icon: "event", text: "Deadline: 15 Oct 2024", color: "text-red-600" },
        ],
        action: "Apply Now →", actionStyle: "bg-primary text-slate-900 dark:text-slate-100 hover:bg-primary-dark hover:text-white",
        actionLink: "/register",
    },
    {
        ...
        action: "Preview", actionStyle: "border border-slate-200 dark:border-white/10 text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:bg-[#0a0a0a]",
        action2: "PDF", action2Style: "bg-slate-900 text-white hover:bg-slate-700 dark:bg-slate-800",
        starred: true,
    },
    {
        ...
        details: [
            { icon: "business", text: "Agency: QCI India", color: "text-slate-500 dark:text-slate-400" },
            { icon: "schedule", text: "Process: 4-6 Weeks", color: "text-amber-600" },
        ],
        action: "View Requirements", actionStyle: "border border-slate-200 dark:border-white/10 text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:bg-[#0a0a0a]",
    },
    {
        ...
        details: [
            { icon: "location_on", text: "Location: RIS, New Delhi", color: "text-slate-500 dark:text-slate-400" },
            { icon: "groups", text: "Cohorts: Summer 2024", color: "text-slate-500 dark:text-slate-400" },
        ],
        action: "Apply Now →", actionStyle: "bg-primary text-slate-900 dark:text-slate-100 hover:bg-primary-dark hover:text-white",
        actionLink: "/register",
    },
    ...
    },
    {
        ...
        details: [
            { icon: "public", text: "Target: Global Markets", color: "text-slate-500 dark:text-slate-400" },
            { icon: "update", text: "Updated: Sep 2024", color: "text-slate-500 dark:text-slate-400" },
        ],
        action: "Download Guidelines", actionStyle: "border border-slate-200 dark:border-white/10 text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:bg-[#0a0a0a]",
    },
    {
        type: "Funding", category: "Funding & Grants",
        typeColor: "bg-green-50 text-green-700 border-green-200",
        ...
        details: [
            ...
            { icon: "account_balance_wallet", text: "Grant: Up to ₹20 Lakhs", color: "text-slate-500 dark:text-slate-400" },
    ...
    },
    {
        ...
        details: [
            { icon: "business", text: "Agency: State Drug Controller", color: "text-slate-500 dark:text-slate-400" },
    ...
    },
    {
        ...
        details: [
            { icon: "location_on", text: "Location: AIIA, New Delhi", color: "text-slate-500 dark:text-slate-400" },
            { icon: "groups", text: "Rolling Admissions", color: "text-slate-500 dark:text-slate-400" },
        ],
        action: "Apply Now →", actionStyle: "bg-primary text-slate-900 dark:text-slate-100 hover:bg-primary-dark hover:text-white",
        actionLink: "/register",
    },
    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-[#0a0a0a] font-display">
            ...
            <nav className="sticky top-0 z-50 bg-white/90 dark:bg-black/90 backdrop-blur-md border-b border-slate-200 dark:border-white/10">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center h-16">
                    <Link href="/" className="flex items-center gap-2">
                        ...
                        <span className="font-bold text-lg text-slate-900 dark:text-slate-100">AYUSH<span className="font-normal">Hub</span></span>
                        <span className="text-[10px] text-slate-500 dark:text-slate-400 uppercase ml-1">Start-up Portal</span>
                    </Link>
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                <div className="max-w-2xl mx-auto flex items-center bg-white dark:bg-[#111111] rounded-xl border border-slate-200 dark:border-white/10 shadow-[0_4px_20px_rgba(0,0,0,0.5)] overflow-hidden px-4">
                    <span className="material-icons text-slate-500 dark:text-slate-400">search</span>
                    <input
                        type="text"
                        value={searchQuery}
                    ...
                    />
                    {searchQuery && (
                        <button onClick={() => setSearchQuery("")} className="text-slate-500 dark:text-slate-400 hover:text-slate-500 dark:text-slate-400 mr-2">
                            <span className="material-icons text-sm">close</span>
                        </button>
                    )}
                    <button className="px-5 py-2 bg-slate-900 text-white rounded-lg text-sm font-medium hover:bg-slate-800 dark:bg-slate-800 dark:hover:bg-slate-700">Search</button>
                </div>
                <div className="mt-3 text-xs text-slate-500 dark:text-slate-400 space-x-3">
                    <span>Trending:</span>
                    {["Startup India Grant", "Clinical Trials", "GMP Certification"].map((t) => (
                        <button key={t} onClick={() => setSearchQuery(t)} className="text-slate-500 dark:text-slate-400 hover:text-primary-dark transition-colors">{t}</button>
                    ))}
                </div>
            </div>
            </section>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                <div className="flex flex-wrap items-center justify-between gap-4 mb-8">
                        ...
                        {categories.map((cat) => (
                            <button
                                ...
                                className={`px-4 py-2 rounded-full text-sm font-medium transition-all ${activeCategory === cat
                                    ? "bg-primary text-slate-900 dark:text-slate-100 shadow-[0_4px_20px_rgba(0,0,0,0.5)]"
                                    : "bg-white dark:bg-[#111111] text-slate-500 dark:text-slate-400 border border-slate-200 dark:border-white/10 hover:bg-slate-50 dark:bg-[#0a0a0a]"
                                    }`}
                            >
                                {cat}
                            </button>
                    ...
                    <div className="flex items-center gap-2 text-sm text-slate-500 dark:text-slate-400">
                        ...
                        <select
                            ...
                            className="border border-slate-200 dark:border-white/10 rounded-lg px-3 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-primary/50"
                        >
                ...
                {filtered.length === 0 && (
                    <div className="text-center py-16">
                        ...
                        <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-2">No resources found</h3>
                        <p className="text-sm text-slate-500 dark:text-slate-400 mb-4">Try adjusting your search or filter criteria.</p>
                        <button onClick={() => { setSearchQuery(""); setActiveCategory("All Resources"); }} className="px-4 py-2 bg-primary rounded-lg text-sm font-medium text-slate-900 dark:text-slate-100 hover:bg-primary-dark hover:text-white">
                            Clear Filters
                        </button>
                    </div>
                )}
                                ...
                                <div className="p-6">
                                    <div className="flex justify-between items-start mb-3">
                                        ...
                                        <button onClick={() => toggleBookmark(origIdx)} className="transition-colors">
                                            <span className={`material-icons text-lg ${bookmarked.has(origIdx) ? "text-amber-400" : "text-slate-700 dark:text-slate-300 hover:text-amber-400"}`}>
                                                {bookmarked.has(origIdx) ? "star" : "bookmark_border"}
                                            </span>
                                        </button>
                                    </div>
                                    <h3 className="font-bold text-slate-900 dark:text-slate-100 mb-2">{resource.title}</h3>
                                    <p className="text-xs text-slate-500 dark:text-slate-400 mb-4 leading-relaxed">{resource.desc}</p>

                                    {resource.tags && (
                                        <div className="flex flex-wrap gap-1.5 mb-4">
                                            {resource.tags.map((tag) => (
                                                <span key={tag} className="px-2 py-0.5 bg-slate-100 dark:bg-[#141414] text-slate-500 dark:text-slate-400 text-[10px] rounded-md">{tag}</span>
                                            ))}
                                        </div>
                                    )}
                                        ...
                                        <div className="space-y-2 mb-4">
                                            {resource.details.map((detail, i) => (
                                                <div key={i} className="flex items-center gap-2 text-xs">
                                                    ...
                                                    <span className="text-slate-500 dark:text-slate-400">{detail.text}</span>
                                                </div>
                                            ))}
                                        </div>
                                    )}
            ...
            <div className="bg-primary/5 border-y border-primary/10">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
                        <div><div className="text-3xl font-bold text-slate-900 dark:text-slate-100">500+</div><div className="text-sm text-slate-500 dark:text-slate-400 mt-1 uppercase tracking-wider">Registered Startups</div></div>
                        <div><div className="text-3xl font-bold text-slate-900 dark:text-slate-100">₹200Cr</div><div className="text-sm text-slate-500 dark:text-slate-400 mt-1 uppercase tracking-wider">Grants Disbursed</div></div>
                        <div><div className="text-3xl font-bold text-slate-900 dark:text-slate-100">1.2k</div><div className="text-sm text-slate-500 dark:text-slate-400 mt-1 uppercase tracking-wider">Research Papers</div></div>
                        <div><div className="text-3xl font-bold text-slate-900 dark:text-slate-100">50+</div><div className="text-sm text-slate-500 dark:text-slate-400 mt-1 uppercase tracking-wider">Incubators</div></div>
                    </div>
                </div>
            </div>

            {/* Footer */}
            <footer className="bg-white dark:bg-[#111111] border-t border-slate-200 dark:border-white/10 py-12">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                        <div>
                            <div className="flex items-center gap-2 mb-4">
                                <div className="w-7 h-7 bg-primary rounded-lg flex items-center justify-center text-slate-900 dark:text-slate-100 font-bold text-xs">A</div>
                                <span className="font-bold text-slate-900 dark:text-slate-100">AYUSH<span className="font-normal">Hub</span></span>
                            </div>
                            <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">A Government of India initiative to promote startups and innovation in the field of Ayurveda, Yoga, Unani, Siddha, and Homeopathy.</p>
                        </div>
                        <div>
                            <h4 className="font-bold text-sm text-slate-900 dark:text-slate-100 mb-4">Quick Links</h4>
                        ...
                        <div>
                            <h4 className="font-bold text-sm text-slate-900 dark:text-slate-100 mb-4">Resources</h4>
                            <ul className="space-y-2 text-xs text-slate-500 dark:text-slate-400">
                        ...
                        <div>
                            <h4 className="font-bold text-sm text-slate-900 dark:text-slate-100 mb-4">Contact</h4>
                            <ul className="space-y-2 text-xs text-slate-500 dark:text-slate-400">
                    ...
                    <div className="border-t border-slate-200 dark:border-white/5 flex justify-center py-6 text-sm text-gray-500 font-medium">
