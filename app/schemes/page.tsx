...
const resources = [
    ...
    },
    {
        ...
        action2: "PDF", action2Style: "bg-slate-900 text-white hover:bg-slate-100 dark:bg-slate-800",
        starred: true,
    },
    {
        ...
        <div className="min-h-screen bg-background-light font-display">
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                <div className="max-w-2xl mx-auto flex items-center bg-white dark:bg-[#111111] rounded-xl border border-slate-200 dark:border-white/10 shadow-[0_4px_20px_rgba(0,0,0,0.5)] overflow-hidden px-4">
                    ...
                    <button className="px-5 py-2 bg-slate-900 text-white rounded-lg text-sm font-medium hover:bg-slate-100 dark:bg-slate-800">Search</button>
                </div>
