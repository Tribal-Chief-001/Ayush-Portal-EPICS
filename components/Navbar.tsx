...
export default function Navbar() {
    ...
    return (
        <nav className="sticky top-0 z-50 w-full bg-white/80 dark:bg-[#0a0a0a]/90 backdrop-blur-xl border-b border-black/5 dark:border-white/10 shadow-lg transition-colors duration-300">
