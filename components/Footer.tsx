...
export default function Footer() {
    return (
        <footer className="bg-white dark:bg-[#111111] border-t border-slate-200 dark:border-white/10 pt-16 pb-8 mt-auto">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
                    <div className="lg:col-span-2">
                        <div className="flex items-center gap-2 mb-6">
                            <span className="material-icons text-primary-dark text-4xl">spa</span>
                            <span className="font-bold text-2xl text-slate-900 dark:text-slate-100">AYUSH Portal</span>
                        </div>
                        ...
                        <div className="flex gap-4">
                            <a href="#" className="w-10 h-10 rounded-full bg-slate-100 dark:bg-[#141414] flex items-center justify-center text-slate-500 dark:text-slate-400 hover:bg-primary hover:text-slate-900 dark:text-slate-100 transition-colors">
                    ...
                    <div>
                        <h4 className="font-bold text-slate-900 dark:text-slate-100 mb-6">Resources</h4>
                        <ul className="space-y-4 text-sm text-slate-500 dark:text-slate-400">
                ...
                <div className="border-t border-slate-200 dark:border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                    <p className="text-xs text-slate-500 dark:text-slate-400 text-center md:text-left">
                        © 2024 Ministry of Ayush. All rights reserved. | <a href="#" className="underline hover:text-slate-800 dark:text-slate-200">Privacy Policy</a> | <a href="#" className="underline hover:text-slate-800 dark:text-slate-200">Terms of Use</a>
                    </p>
                    <div className="flex items-center gap-2 text-xs text-slate-500 dark:text-slate-400">
                        <span>Designed for</span>
                        <span className="font-bold text-slate-500 dark:text-slate-400">AYUSH</span>
                    </div>
                </div>
            </div>
        </footer>
